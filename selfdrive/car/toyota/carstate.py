...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam):
    ...
    ret.steerFaultTemporary = cp.vl["EPS_STATUS"]["LKA_STATE"] not in [1, 3, 5]
  ...
  def get_can_parser(CP):
    ...
    if CP.carFingerprint == CAR.COROLLA_2010:
      ...
      signals.append(("WHEEL_SPEED_FR", "WHEEL_SPEEDS_FRONT"))
      signals.append(("WHEEL_SPEED_RL", "WHEEL_SPEEDS_REAR"))
