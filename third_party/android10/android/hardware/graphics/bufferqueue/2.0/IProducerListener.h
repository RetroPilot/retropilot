#ifndef HIDL_GENERATED_ANDROID_HARDWARE_GRAPHICS_BUFFERQUEUE_V2_0_IPRODUCERLISTENER_H
#define HIDL_GENERATED_ANDROID_HARDWARE_GRAPHICS_BUFFERQUEUE_V2_0_IPRODUCERLISTENER_H
...
struct IProducerListener : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.graphics.bufferqueue@2.0::IProducerListener"
     */
     ...
     *     onBufferReleased()).
     */
    virtual ::android::hardware::Return<void> onBuffersReleased(uint32_t count) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::graphics::bufferqueue::V2_0::IProducerListener>> castFrom(const ::android::sp<::android::hardware::graphics::bufferqueue::V2_0::IProducerListener>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::graphics::bufferqueue::V2_0::IProducerListener>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::graphics::bufferqueue::V2_0::IProducerListener>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::graphics::bufferqueue::V2_0::IProducerListener>& o) {
    ...
    os += ::android::hardware::graphics::bufferqueue::V2_0::IProducerListener::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_GRAPHICS_BUFFERQUEUE_V2_0_IPRODUCERLISTENER_H
