...
namespace hardware {
namespace details {
template<> constexpr std::array<::android::hardware::graphics::bufferqueue::V1_0::IGraphicBufferProducer::FenceTimeSnapshot::State, 3> hidl_enum_values<::android::hardware::graphics::bufferqueue::V1_0::IGraphicBufferProducer::FenceTimeSnapshot::State> = {
...
namespace hardware {
namespace details {
template<> constexpr std::array<::android::hardware::graphics::bufferqueue::V1_0::IGraphicBufferProducer::DisconnectMode, 2> hidl_enum_values<::android::hardware::graphics::bufferqueue::V1_0::IGraphicBufferProducer::DisconnectMode> = {
