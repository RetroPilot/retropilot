...
from qti.aisw.converters.common.converter_ir.op_adapter import RNormOp
...
class LrnLayerBuilder(LayerBuilder):
    def build_layer(self, ir_graph, converter_context, descriptor, input_descriptors, output_descriptors):
        ...
        return ir_graph.add(RNormOp(name=descriptor.layer_name,
                                    size=descriptor.window_size,
